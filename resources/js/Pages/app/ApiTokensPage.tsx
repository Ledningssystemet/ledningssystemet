...
export default function ApiTokensPage({ route }: ApiTokensPageProps) {
    ...
    useEffect(() => {
        ...
        document.title = t('ui.app.page_title_suffix', { page: t('pages.api_tokens.title') });
        return () => {
        ...
        <AppLayout>
            <div className="space-y-6">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>/</span>
                    <span>{t('pages.api_tokens.title')}</span>
                </nav>
                ...
                <section className="rounded-2xl border border-border bg-card p-6 shadow-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold tracking-tight text-foreground">{t('pages.api_tokens.title')}</h1>
                            <p className="mt-1 text-sm text-muted-foreground">
                                {route.description ?? t('pages.api_tokens.description')}
                            </p>
                        </div>
                    </div>
                </section>
