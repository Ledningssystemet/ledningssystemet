...
export default function SustainabilityAspectsPage({ route }: SustainabilityAspectsPageProps) {
    ...
    useEffect(() => {
        ...
        document.title = t('ui.app.page_title_suffix', { page: t('pages.sustainability_aspects.title') });
        ...
        <AppLayout>
            <div className="space-y-6">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>/</span>
                    <span>{t('pages.sustainability_aspects.title')}</span>
                </nav>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold tracking-tight text-foreground">
                                {t('pages.sustainability_aspects.title')}
                            </h1>
                            <p className="mt-1 text-sm text-muted-foreground">
                                {route.description ?? t('pages.sustainability_aspects.description')}
                            </p>
                        </div>
                    </div>
                </section>
