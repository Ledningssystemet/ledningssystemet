...
export default function ObjectivesPage({ route }: ObjectivesPageProps) {
    ...
    useEffect(() => {
        ...
        document.title = t('ui.app.page_title_suffix', { page: t('pages.objectives.title') });
        ...
        <AppLayout>
            <div className="space-y-6">
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>/</span>
                    <span>{t('pages.objectives.title')}</span>
                </nav>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                                {route.description ?? t('pages.objectives.description')}
                            </p>
                        </div>
                    </div>
                </section>
