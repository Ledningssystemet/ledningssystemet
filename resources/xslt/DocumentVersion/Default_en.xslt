...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <footer>
                    Printed document is not guaranteed to be valid. Always refer to the digital version for the latest information.
                </footer>
                <xsl:apply-templates/>
            </body>
        </html>
    ...
    <xsl:template match="document">
        <table class="metadata">
            <tr>
                <td>
                    <strong>Version:</strong><p><xsl:value-of select="doc_major"/>.<xsl:value-of select="doc_minor"/><xsl:if test="draft='true'"> (Draft)</xsl:if></p>
                </td>
                <td>
                    <strong>Author:</strong><p><xsl:value-of select="doc_author"/></p>
                </td>
                <td>
                    <strong>Approved by:</strong><p><xsl:if test="draft='true'">- Not approved -</xsl:if><xsl:if test="draft!='true'"><xsl:value-of select="doc_approver"/></xsl:if></p>
                </td>
            </tr>
        </table>
