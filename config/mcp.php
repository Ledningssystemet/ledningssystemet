...
return [
    ...
    */
    'server' => [
        'name' => env('MCP_SERVER_NAME', 'Ledningssystemet MCP'),
        'version' => env('MCP_SERVER_VERSION', '1.0.0'),
        'instructions' => env('MCP_SERVER_INSTRUCTIONS', 'This is the MCP server for Ledningssystemet – a management system for ISO/quality/risk management. Use the available tools to query processes, risks, assets, controls, compliance evaluations, incidents, and organizational data. All responses are read-only. Authenticate using a Sanctum Bearer token.'),
    ],
