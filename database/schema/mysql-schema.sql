...
CONSTRAINT `ghg_factors_ghg_conversion_factor_id_foreign` FOREIGN KEY (`ghg_conversion_factor_id`) REFERENCES `ghg_conversion_factors` (`id`) ON UPDATE CASCADE,
CONSTRAINT `ghg_factors_process_performance_metrics_id_foreign` FOREIGN KEY (`process_performance_metrics_id`) REFERENCES `process_performance_metrics` (`id`) ON UPDATE CASCADE,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `risk_template_evaluation_attempts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
