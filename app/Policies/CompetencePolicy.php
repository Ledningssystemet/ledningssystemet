...
class CompetencePolicy
{
     ...
     */
    public function restore(User $user, Competence $competence = new Competence): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, Competence $competence = new Competence): bool
    {
        return false;
    }
}
