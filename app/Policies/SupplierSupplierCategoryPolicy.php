...
class SupplierSupplierCategoryPolicy
{
     ...
     */
    public function view(User $user, SupplierSupplierCategory $supplierSupplierCategory = new SupplierSupplierCategory): bool
    {
        return false;
    }
     ...
     */
    public function update(User $user, SupplierSupplierCategory $supplierSupplierCategory = new SupplierSupplierCategory): bool
    {
        return false;
    }
