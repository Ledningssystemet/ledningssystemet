...
class UserStatusEmailSettingPolicy
{
     ...
     */
    public function view(User $user, UserStatusEmailSetting $userStatusEmailSetting = new UserStatusEmailSetting): bool
    {
        return false;
    }
     ...
     */
    public function update(User $user, UserStatusEmailSetting $userStatusEmailSetting = new UserStatusEmailSetting): bool
    {
        return false;
    }
