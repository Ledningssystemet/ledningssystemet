...
class LibraryDocumentProcessPolicy
{
     ...
     */
    public function restore(User $user, LibraryDocumentProcess $libraryDocumentProcess = new LibraryDocumentProcess): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, LibraryDocumentProcess $libraryDocumentProcess = new LibraryDocumentProcess): bool
    {
        return false;
    }
}
