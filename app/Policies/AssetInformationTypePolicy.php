...
class AssetInformationTypePolicy
{
     ...
     */
    public function restore(User $user, AssetInformationType $assetInformationType = new AssetInformationType): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, AssetInformationType $assetInformationType = new AssetInformationType): bool
    {
        return false;
    }
}
