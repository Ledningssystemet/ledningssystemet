...
class PendingActivityPolicy
{
     ...
     */
    public function restore(User $user, PendingActivity $pendingActivity = new PendingActivity): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, PendingActivity $pendingActivity = new PendingActivity): bool
    {
        return false;
    }
}
