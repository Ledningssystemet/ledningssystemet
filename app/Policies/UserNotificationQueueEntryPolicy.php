...
class UserNotificationQueueEntryPolicy
{
     ...
     */
    public function view(User $user, UserNotificationQueueEntry $userNotificationQueueEntry = new UserNotificationQueueEntry): bool
    {
        return false;
    }
     ...
     */
    public function update(User $user, UserNotificationQueueEntry $userNotificationQueueEntry = new UserNotificationQueueEntry): bool
    {
        return false;
    }
