...
class ObjectPropertyPolicy
{
     ...
     */
    public function view(User $user, ObjectProperty $objectProperty = new ObjectProperty): bool
    {
        return false;
    }
     ...
     */
    public function update(User $user, ObjectProperty $objectProperty = new ObjectProperty): bool
    {
        return false;
    }
