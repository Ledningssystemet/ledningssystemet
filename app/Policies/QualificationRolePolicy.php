...
class QualificationRolePolicy
{
     ...
     */
    public function restore(User $user, QualificationRole $qualificationRole = new QualificationRole): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, QualificationRole $qualificationRole = new QualificationRole): bool
    {
        return false;
    }
}
