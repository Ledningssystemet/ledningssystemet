...
class PropertyTabPolicy
{
     ...
     */
    public function restore(User $user, PropertyTab $propertyTab = new PropertyTab): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, PropertyTab $propertyTab = new PropertyTab): bool
    {
        return false;
    }
}
