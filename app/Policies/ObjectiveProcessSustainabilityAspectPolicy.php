...
class ObjectiveProcessSustainabilityAspectPolicy
{
     ...
     */
    public function view(User $user, ObjectiveProcessSustainabilityAspect $objectiveProcessSustainabilityAspect = new ObjectiveProcessSustainabilityAspect): bool
    {
        return false;
    }
     ...
     */
    public function update(User $user, ObjectiveProcessSustainabilityAspect $objectiveProcessSustainabilityAspect = new ObjectiveProcessSustainabilityAspect): bool
    {
        return false;
    }
