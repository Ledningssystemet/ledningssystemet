...
class ProbabilityLevel extends Model
{
    ...
    protected $table = 'probability_levels';
    ...
    {
        return $plural ? 'Probability Levels' : 'Probability Level';
    }
    ...
    {
        return $this->hasMany(Risk::class, 'post_probability_id', 'id');
    }

    public function int_risks_by_probability(): HasMany
    {
        return $this->hasMany(Risk::class, 'probability_id', 'id');
    }
