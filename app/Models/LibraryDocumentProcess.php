...
class LibraryDocumentProcess extends Model
{
    use HasFactory;
    protected $table = 'library_document_processes';
    protected $fillable = ['process_id', 'library_document_id'];
    ...
    public static function validationRules(): array
    {
        return [
            ...
            'library_document_id' => ['required', 'integer', 'min:0', 'exists:library_documents,id'],
        ];
    }
    ...
    {
        return $plural ? 'Library Document Processes' : 'Library Document Process';
    }
