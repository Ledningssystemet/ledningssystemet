...
{
    use HasFactory;
    protected $table = 'control_risks';
    protected $fillable = ['control_id', 'risk_id'];

    public static function validationRules(): array
    {
        return [
            'control_id' => ['required', 'integer', 'min:0', 'exists:controls,id'],
            'risk_id' => ['required', 'integer', 'min:0', 'exists:risks,id'],
        ];
    }
    ...
    {
        return $plural ? 'Control Risks' : 'Control Risk';
    }
