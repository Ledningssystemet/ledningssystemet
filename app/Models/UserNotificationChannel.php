...
class UserNotificationChannel extends Model
{
    ...
    {
        return $plural ? 'User Notification Channels' : 'User Notification Channel';
    }
    ...
    {
        return $this->hasMany(UserNotificationQueueEntry::class, 'user_notification_channel_id', 'id');
    }
