...
class EmployeeRole extends Model
{
   ...
   /**
    * The qualifications that belong to the role.
    */
   public function int_qualifications() : HasMany
   {
       return $this->hasMany(QualificationRole::class, 'role_id');
   }

   /**
    * The competences that belong to the role.
    */
   public function int_competences() : HasMany
   {
       return $this->hasMany(RoleCompetence::class, 'role_id');
   }
}
