...
class CustomerProcess extends Model
{
    ...
    protected $table = 'customer_process';

    protected $fillable = ['customer_id', 'process_id'];

    public static function validationRules(): array
    {
        return [
            'customer_id' => ['required', 'integer', 'min:0', 'exists:customers,id'],
    ...
    {
        return $plural ? 'Customer Processes' : 'Customer Process';
    }
