...
{
   public static function getPrettyName($plural = false){ if($plural) { return __("Sustainability metrics"); } else { return __("Sustainability metric"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('sustainability_metrics')->ignore($this->id)],
      ];
   }  
   ...
   {
      return $this->hasMany(SustainabilityMetricLevel::class, 'sustainability_metric_id');
   }   
}
