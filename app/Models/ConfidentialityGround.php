...
class ConfidentialityGround extends Model
{
      
   public static function getPrettyName($plural = false){ if($plural) { return __("Confidentiality grounds"); } else { return __("Confidentiality ground"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('data_categories')->ignore($this->id)],
      ];
   }  
