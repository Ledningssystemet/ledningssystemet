...
class LibraryDocument extends Model
{
    ...
    protected $fillable = ['uid', 'partner_id', 'partner_object_uid', 'partner_object_updated_at', 'name', 'filename', 'description', 'contenttype', 'contentlength', 'filecontent', 'responsible_user_id'];
