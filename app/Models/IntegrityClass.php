...
/* Retrieve status for the entire collection of objects */
   public static function getItemsStatus($department = null, $user = null, $personalOnly = false)
   {
    ...
    protected $table = 'integrity_classes';
    ...
    {
        return $plural ? 'Integrity Classes' : 'Integrity Class';
    }

    public function int_assets(): HasMany
    {
        return $this->hasMany(Asset::class, 'integrity_class_id', 'id');
    }

    public function int_information_types(): HasMany
    {
        return $this->hasMany(InformationType::class, 'integrity_class_id', 'id');
    }
