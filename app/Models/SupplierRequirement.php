...
/* Retrieve status for the entire collection of objects */
   ...
   {
      if(\App\Models\SystemConfiguration::get('DISABLE_SUPPLIER', false))
         return [];
    ...
    {
        return $plural ? 'Supplier Requirements' : 'Supplier Requirement';
    }
    ...
    {
        return $this->hasMany(SupplierSupplierRequirement::class, 'supplier_requirement_id', 'id');
    }
