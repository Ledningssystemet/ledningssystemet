...
class AccessGroupUser extends Model
{
    ...
    {
        return [
            'access_group_id' => ['required', 'integer', 'min:0', 'exists:access_groups,id'],
    ...
    {
        return $plural ? 'Access Group Users' : 'Access Group User';
    }

    public function int_access_group(): BelongsTo
    {
