...
class Qualification extends Model
{
    ...
    protected $fillable = ['name', 'description', 'expires'];
    ...
    {
        return $plural ? 'Qualifications' : 'Qualification';
    }

    public function int_qualification_role(): HasMany
    {
        return $this->hasMany(QualificationRole::class, 'qualification_id', 'id');
    }

    public function int_qualification_user(): HasMany
    {
        return $this->hasMany(QualificationUser::class, 'qualification_id', 'id');
    }
