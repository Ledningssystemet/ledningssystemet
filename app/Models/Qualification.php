...
class Qualification extends Model
{
   ...
   public static function getPrettyName($plural = false){ if($plural) { return __("Qualifications"); } else { return __("Qualification"); }}
   ...
   public function getUsersAttribute()
   {
      ...
      foreach($this->int_users as $obj)
         $retval[] = array('id' => $obj->id, 'name' => $obj->name, 'note' => $obj->pivot->note, 'planned_at' => $obj->pivot->planned_at, 'finished_at' => $obj->pivot->finished_at, 'expires_at' => $obj->pivot->expires_at);
   ...
   {
      $retval = [];
      foreach($this->int_qualification_roles as $obj)
         $retval[] = array('id' => $obj->id, 'name' => $obj->name, 'mandatory' => $obj->pivot->mandatory);
    ...
    */
    ...
    {
       return $this->belongsToMany(Role::class, 'qualification_role')->withPivot(['mandatory']);
    }   
    ...
    */
    ...
    {
       return $this->belongsToMany(User::class, 'qualification_user')->withPivot(['note', 'planned_at', 'finished_at', 'expires_at']);
    }   
}
