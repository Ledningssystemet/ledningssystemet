...
{
      public static function getPrettyName($plural = false){ if($plural) { return __("Personal access tokens"); } else { return __("Personal access token"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('personal_access_tokens')->ignore($this->id)],
      ];
   }
}
