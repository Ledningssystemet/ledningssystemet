...
class Competence extends Model
{
    ...
    {
        return $plural ? 'Competences' : 'Competence';
    }

    public function int_competence_levels(): HasMany
    {
        return $this->hasMany(CompetenceLevel::class, 'competence_id', 'id');
    }

    public function int_role_competence(): HasMany
    {
        return $this->hasMany(RoleCompetence::class, 'competence_id', 'id');
    }

    public function int_user_competence(): HasMany
    {
        return $this->hasMany(UserCompetence::class, 'competence_id', 'id');
    }
