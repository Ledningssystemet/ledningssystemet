...
class CustomProperty extends Model
{
    ...
    {
        return $plural ? 'Custom Properties' : 'Custom Property';
    }

    public function int_custom_property_object(): HasMany
    {
        return $this->hasMany(CustomPropertyObject::class, 'custom_property_id', 'id');
    }
