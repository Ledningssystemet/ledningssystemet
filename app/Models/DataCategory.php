...
class DataCategory extends Model
{
    ...
    protected $fillable = ['name', 'description', 'sensitive'];
    ...
    {
        return $plural ? 'Data Categories' : 'Data Category';
    }

    public function int_data_category_information_type(): HasMany
    {
        return $this->hasMany(DataCategoryInformationType::class, 'data_category_id', 'id');
    }

    public function int_information_types(): BelongsToMany
    {
        return $this->belongsToMany(InformationType::class, 'data_category_information_type', 'data_category_id', 'information_type_id');
    }
