...
class ObjectiveProcessPerformanceMetric extends Model
{
    ...
    public static function validationRules(): array
    {
        return [
            ...
            'objective_target_value' => ['required', 'integer'],
            'objective_acceptable_value' => ['required', 'integer'],
    ...
    {
        return $plural ? 'Objective Process Performance Metrics' : 'Objective Process Performance Metric';
    }
