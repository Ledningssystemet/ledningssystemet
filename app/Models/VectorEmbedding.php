...
class VectorEmbedding extends Model
{
    ...
    {
        return [
            'embeddable_type' => ['required', 'string', 'max:255'],
            'embeddable_id' => ['required', 'integer', 'min:0'],
            'provider' => ['required', 'string', 'max:50'],
            'embedding_model' => ['nullable', 'string', 'max:100'],
            'dimensions' => ['nullable', 'integer', 'min:0'],
            'content_hash' => ['nullable', 'string', 'max:40'],
    ...
    {
        return $plural ? 'Vector Embeddings' : 'Vector Embedding';
    }

    public function int_embeddable(): MorphTo
    {
