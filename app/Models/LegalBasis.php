...
class LegalBasis extends Model
{
    ...
    {
        return $plural ? 'Legal Basises' : 'Legal Basis';
    }

    public function int_legal_basis_process(): HasMany
    {
        return $this->hasMany(LegalBasisProcess::class, 'legal_basis_id', 'id');
    }

    public function int_processes(): BelongsToMany
    {
        return $this->belongsToMany(Process::class, 'legal_basis_process', 'legal_basis_id', 'process_id');
    }
