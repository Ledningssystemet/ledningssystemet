...
class LegalBasis extends Model
{
   ...
   public static function getPrettyName($plural = false){ if($plural) { return __("Legal basises"); } else { return __("Legal basis"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('legal_bases')->ignore($this->id)],
