...
class ProcessLink extends Model
{
    ...
    protected $fillable = ['linked_process_id', 'process_id'];

    public static function validationRules(): array
    {
        return [
            'linked_process_id' => ['required', 'integer', 'min:0', 'exists:processes,id'],
    ...
    {
        return $plural ? 'Process Links' : 'Process Link';
    }

    public function int_linked_process(): BelongsTo
    {
        return $this->belongsTo(Process::class, 'linked_process_id');
    }
