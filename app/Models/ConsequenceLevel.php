...
class ConsequenceLevel extends Model
{
   ...
   public static function getPrettyName($plural = false){ if($plural) { return __("Consequence levels"); } else { return __("Consequence level"); }}
   ...
   public static function boot()
   {
      ...
      static::deleting(function ($model) {
         if($model->int_risks()->count())
            abort(400, __("You may not delete a consequence level that is in use"));
      });
   }
   ...
   /**
    * Get the risks with this consequence level
    */
   public function int_risks() : HasMany
   {
       return $this->hasMany(Risk::class, 'consequence_id');
   }   
}