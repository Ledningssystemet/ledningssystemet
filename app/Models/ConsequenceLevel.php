...
{
    use HasFactory;
    protected $table = 'consequence_levels';
    ...
    {
        return $plural ? 'Consequence Levels' : 'Consequence Level';
    }
    ...
    {
        return $this->hasMany(Risk::class, 'consequence_id', 'id');
    }

    public function int_risks_by_post_consequence(): HasMany
    {
        return $this->hasMany(Risk::class, 'post_consequence_id', 'id');
    }
