...
class RecipientCategory extends Model
{
   ...
   public static function getPrettyName($plural = false){ if($plural) { return __("Recipient categories"); } else { return __("Recipient category"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('recipient_categories')->ignore($this->id)],
      ];
   }
