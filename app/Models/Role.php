...
class Role extends Model
{
    ...
    public function int_process_activities_by_accountable_role(): HasMany
    {
        return $this->hasMany(ProcessActivity::class, 'accountable_role_id', 'id');
    }

    public function int_process_activities_by_responsible_role(): HasMany
    {
        return $this->hasMany(ProcessActivity::class, 'responsible_role_id', 'id');
    }

    public function int_qualification_role(): HasMany
    {
        return $this->hasMany(QualificationRole::class, 'role_id', 'id');
    }

    public function int_role_competence(): HasMany
    {
        return $this->hasMany(RoleCompetence::class, 'role_id', 'id');
    }
