...
class UserCompetence extends Model
{
    ...
    protected $fillable = ['competence_id', 'user_id', 'competence_level_id', 'updated_by_name', 'note'];
    ...
    public static function validationRules(): array
    {
        return [
            ...
            'competence_level_id' => ['required', 'integer', 'min:0', 'exists:competence_levels,id'],
    ...
    {
        return $plural ? 'User Competences' : 'User Competence';
    }
    ...
    public function int_competence_level(): BelongsTo
    {
