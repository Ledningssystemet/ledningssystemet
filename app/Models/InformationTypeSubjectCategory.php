...
class InformationTypeSubjectCategory extends Model
{
    ...
    public static function validationRules(): array
    {
        return [
            ...
            'subject_category_id' => ['required', 'integer', 'min:0', 'exists:subject_categories,id'],
        ];
    }
    ...
    {
        return $plural ? 'Information Type Subject Categories' : 'Information Type Subject Category';
    }
    ...
    public function int_subject_category(): BelongsTo
    {
