...
class LegalBasisProcess extends Model
{
    use HasFactory;
    protected $table = 'legal_basis_process';
    protected $fillable = ['legal_basis_id', 'process_id'];

    public static function validationRules(): array
    {
        return [
            'legal_basis_id' => ['required', 'integer', 'min:0', 'exists:legal_bases,id'],
    ...
    {
        return $plural ? 'Legal Basis Processes' : 'Legal Basis Process';
    }

    public function int_legal_basis(): BelongsTo
    {
        return $this->belongsTo(LegalBasis::class, 'legal_basis_id');
    }
