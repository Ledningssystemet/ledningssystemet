...
class ConfidentialityClass extends Model
{
   ...
   public static function getPrettyName($plural = false){ if($plural) { return __("Confidentiality classes"); } else { return __("Confidentiality class"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('confidentiality_classes')->ignore($this->id)],
   ...
   */
   public function reorder()
   {
      ...
      $afterobj = (null == $after) ? null : ConfidentialityClass::findOrFail($after);
      ...
      $ordinal = 2;
      foreach(ConfidentialityClass::orderBy('ordinal')->get() as $obj)
      {
         $obj->ordinal = $ordinal;
         $obj->save();
