...
{
      public static function getPrettyName($plural = false){ if($plural) { return __("Subject categories"); } else { return __("Subject category"); }}
   ...
   {
      return [
         'name' => ['required', Rule::unique('subject_categories')->ignore($this->id)],
      ];
   }  
