...
class SubjectCategory extends Model
{
    ...
    {
        return $plural ? 'Subject Categories' : 'Subject Category';
    }

    public function int_information_type_subject_category(): HasMany
    {
        return $this->hasMany(InformationTypeSubjectCategory::class, 'subject_category_id', 'id');
    }

    public function int_information_types(): BelongsToMany
    {
        return $this->belongsToMany(InformationType::class, 'information_type_subject_category', 'subject_category_id', 'information_type_id');
    }
