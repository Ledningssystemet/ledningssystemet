...
class UserStatusEmailSetting extends Model
{
    use HasFactory;
    protected $table = 'user_status_email_settings';
    ...
    {
        return $plural ? 'User Status Email Settings' : 'User Status Email Setting';
    }
